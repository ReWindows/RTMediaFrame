...
static constexpr wchar_t module_name[17] = {0x0052, 0x0054, 0x004D, 0x0065, 0x0064, 0x0069, 0x0061, 0x0046, 0x0072, 0x0061, 0x006D, 0x0065, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2240002584U || rva >= image_size) return nullptr;
return base + rva;
}
