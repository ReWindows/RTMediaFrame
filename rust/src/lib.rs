//! Windissect-generated Rust FFI bindings for RTMediaFrame.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "C2575B0256F393C3262ECD8B288877D7";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2240002584;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 17] = [82, 84, 77, 101, 100, 105, 97, 70, 114, 97, 109, 101, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2240002584 { return 0; }
